...
export default function ExportRibbon({ title, author, vocab, notes, isChatOpen }: ExportRibbonProps) {
  ...
  const exportTranslationsPDF = async () => {
    ...
    wrapper.innerHTML = `
      <div style="margin-bottom:18px; border-bottom: 2px solid #10175b; padding-bottom: 12px; display: flex; justify-content: space-between; align-items: flex-end;">
        <div>
          <div style="font-size: 18px; font-weight: 800; color: #10175b; letter-spacing: -0.02em; margin-bottom: 4px;">BookBudddy</div>
      ...
      <div style="margin-top:28px;font-size:8px;color:#9ca3af;text-align:center;">Generated by BookBudddy</div>
    `;
    ...
    wrapper.innerHTML = `
      <div style="margin-bottom:28px; border-bottom: 2px solid #10175b; padding-bottom: 16px;">
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
          <div style="font-size: 24px; font-weight: 800; color: #10175b; letter-spacing: -0.02em;">BookBudddy</div>
  ...
  return (
    <div className="absolute md:fixed right-0 top-40 z-40 flex items-center" ref={containerRef}>
      <motion.div
        initial={false}
