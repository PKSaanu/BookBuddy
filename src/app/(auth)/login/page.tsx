  ...
  return (
    <div className="min-h-screen bg-[#F4F5F6] flex flex-col justify-center py-12 px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md mb-10 text-center">
        ...
        <h2 className="text-4xl font-serif font-black text-[#10175b] tracking-tight">Welcome Back</h2>
        <p className="mt-3 text-slate-500 font-medium tracking-wide">Enter your details to access your library</p>
      </div>
        ...
        <div className="bg-white py-12 px-10 shadow-2xl shadow-[#10175b]/5 rounded-[32px] border border-slate-100">
          ...
          <div className="mt-10 text-center">
            <p className="text-sm font-medium text-slate-500">
              New to BookBuddy?{' '}
              <Link href="/register" className="font-bold text-[#10175b] hover:underline underline-offset-4 decoration-2">
                Create an account
              </Link>
            </p>
          </div>
